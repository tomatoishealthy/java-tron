...
```
docker run -it -d -p 8090:8090 -p 8091:8091 -p 18888:18888 -p 50051:50051 tronprotocol/java-tron --restart always
```
...
This image also supports custom some other startup parameters，here is an example for production env:
```
