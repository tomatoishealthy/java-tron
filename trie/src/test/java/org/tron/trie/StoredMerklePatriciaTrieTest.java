...
import org.tron.kvstore.KeyValueStorage;
import org.tron.kvstore.InMemoryKeyValueStorage;
...
/*
    MerklePatriciaTrie<Bytes, String> trienew =
        new StoredMerklePatriciaTrie<>(
            merkleStorage::get, valueSerializer, valueDeserializer);
    trienew.put(key1, value3);
    trienew.commit(merkleStorage::put);
    assertThat(trienew.get(key1)).isEqualTo(Optional.of("value3"));
    System.out.println(trienew.getRootHash());*/
