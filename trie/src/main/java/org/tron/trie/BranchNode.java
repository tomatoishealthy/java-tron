...
import org.tron.rlp.BytesValueRLPOutput;
import org.tron.rlp.RLP;
...
import static org.tron.crypto.Hash.keccak256;
...
//      } else if (value.isEmpty() && allowFlatten) {   // to be delete
